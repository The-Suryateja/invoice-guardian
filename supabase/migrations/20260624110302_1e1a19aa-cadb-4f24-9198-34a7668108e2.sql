...
-- Enums
CREATE TYPE public.invoice_status AS ENUM ('uploaded','extracting','pending_review','saved','flagged','archived');
CREATE TYPE public.flag_type AS ENUM ('exact_duplicate','near_duplicate','math_mismatch','vendor_outlier');
...
-- Storage policies for invoices bucket (bucket created via tool)
